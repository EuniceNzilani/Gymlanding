    ...
    <section id="faq" style={{background: '#ffd4a3', padding: isMobile ? '2rem 1rem' : '4rem 2rem', width: '100%', boxSizing: 'border-box'}}>
      <div style={{width: '100%', maxWidth: 900, margin: '0 auto'}}>
        ...
        <div style={{display: 'grid', gap: '1.25rem'}}>
          <details style={{background: '#fff', padding: isMobile ? '1.25rem' : '1.75rem', borderRadius: 12, boxShadow: '0 2px 8px rgba(0,0,0,0.04)', cursor: 'pointer', border: '1px solid #f1f5f9', transition: 'all 0.3s'}} open>
          ...
          <details style={{background: '#fff', padding: isMobile ? '1.25rem' : '1.75rem', borderRadius: 12, boxShadow: '0 2px 8px rgba(0,0,0,0.04)', cursor: 'pointer', border: '1px solid #f1f5f9', transition: 'all 0.3s'}}>
            <summary style={{fontWeight: 600, color: '#0f172a', fontSize: isMobile ? '0.95rem' : '1.05rem', outline: 'none', display: 'flex', justifyContent: 'space-between', alignItems: 'center', userSelect: 'none'}} 
              onMouseEnter={(e) => e.currentTarget.style.color = '#ff8a00'}
              onMouseLeave={(e) => e.currentTarget.style.color = '#0f172a'}>
