...
export default function Pricing() {
  return (
    <section id="pricing" className="bg-white/62 px-0.5 py-8 md:p-14 relative overflow-hidden w-full box-border">
      ...
      <div className="max-w-7xl mx-auto bg-orange-200 px-6 py-8 md:p-8 rounded-2xl relative z-10">
        ...
        <AnimatedSection direction="none" delay={0}>
          <div className="flex justify-between items-start">
            ...
            <button className="hidden md:block bg-orange-600 text-white border-none px-5 py-3 rounded-lg font-bold cursor-pointer text-sm md:text-base">Get Started</button>
          </div>
          <button className="md:hidden bg-orange-600 text-white border-none px-5 py-3 rounded-lg font-bold cursor-pointer text-sm mb-4">Get Started</button>
        </AnimatedSection>
